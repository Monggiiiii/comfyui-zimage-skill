#!/usr/bin/env python3
"""
Riko Style Upscale Script (No LoRA)
Uses URL input for direct upscaling
"""
...
# Upscale workflow (no LoRA, direct UNet connection)
UPSCALE_WORKFLOW = {
    ...
    "47": {"inputs": {"shift": 3, "model": ["46", 0]}, "class_type": "ModelSamplingAuraFlow"},  # Direct UNet connection, no LoRA
    "67": {"inputs": {"filename_prefix": "RikoUpscaled", "images": ["70", 0]}, "class_type": "SaveImage"},
    "70": {
        "inputs": {
    ...
    "71": {"inputs": {"model_name": "RealESRGAN_x4plus.pth"}, "class_type": "UpscaleModelLoader"},
